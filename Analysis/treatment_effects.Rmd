...
```{r}
 sim.results.screen.tt <- EMODAnalyzeR::read.simulation.results(
  results_path = "/gpfs/data/bershteynlab/EMOD/citrod01/MATUMAINI/202301_Nyanza_MATUMAINI_MalariaOngoing/treat/Baseline-campaign_MATUMAINI_202305-treat_screen/ReportHIVByAgeAndGender/",
...
```{r}
sim.results.all <- rbind(sim.results.minimal, sim.results.uni.tt)
```
