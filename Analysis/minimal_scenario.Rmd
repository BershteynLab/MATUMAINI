...
# No risk
res.path.cmd = "/gpfs/scratch/citrod01/experiments/MATUMAINI/Baseline-campaign_MATUMAINI_202305-norisk___2023_08_09_16_24_59_917797"
# 1960-1990 only
res.path.cmd = "/gpfs/scratch/citrod01/experiments/MATUMAINI/Baseline-campaign_MATUMAINI_202305-norisk_early___2023_08_10_11_56_26_611511"
res.path.cmd = "/gpfs/scratch/citrod01/experiments/MATUMAINI/Baseline-campaign_MATUMAINI_202305-norisk_early___2023_08_10_16_28_47_883536"
res.path.cmd = "/gpfs/scratch/citrod01/experiments/MATUMAINI/Baseline-campaign_MATUMAINI_202305-norisk_early___2023_08_10_17_49_57_480807"
res.path.cmd = "/gpfs/scratch/citrod01/experiments/MATUMAINI/Baseline-campaign_MATUMAINI_202305-norisk_adj___2023_08_11_11_27_11_280838"
...
ggplot() + 
  geom_line(dat, mapping = aes(x = Year, y = Prevalence, color = scenario)) + 
...
data <- sim.results %>% 
  ...
  #summarize(Population = sum(Population * pop.scaling.factor), .groups = 'keep') %>% 
  summarize(Population = sum(Population/total.pop.x), .groups = 'keep') %>% 
  group_by(Year, Gender, IP_Key.Risk) %>% 
  summarize(Population = mean(Population), .groups = 'keep')
...
```{r}
data %>% filter( Year == 1985)
```
```{r}
data.orig %>% filter( Year == 1985)
```
