...
sim.results.cmdinc.delay.adh.dropout2.artswitch <- EMODAnalyzeR::read.simulation.results.bigpurple(
  experiment_path = experiment_path.artswitch,
...
sim.results.decouple.delay.adh.dropout2.artswitch <- EMODAnalyzeR::read.simulation.results.bigpurple(
  experiment_path = experiment_path.artswitch,
...
sim.results.all <- rbind(sim.results.decouple,
                         ...
                         sim.results.decouple.delay.adh.dropout2.artswitch,
                         sim.results.cmdinc.delay.adh.dropout2.artswitch
                         )
```
