...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art___2024_08_26_12_26_22_530899"
...
```{r}
# Version 7 August 2024
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-baseline_art_cmdinc___2024_08_20_14_59_08_883121"
...
# Version 7 2024
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_hivinc_hivtr___2024_08_30_17_23_33_771559"
...
```{r}
# Version 7
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_delay___2024_09_06_12_06_32_566087/"
...
```{r}
# Version 7
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_artdrop___2024_09_06_12_08_59_926419/"
...
## Decouple, all treatment effects - Decouple_TX

```{r}
# Version 7
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_tx___2024_09_06_12_04_05_763709"
...
## Decouple, All ART adherence effects
```{r}
# Version 7
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_artswitch_artadh___2024_09_06_12_01_32_985106"
...
```{r}
# Version 7 August 2024
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_art_not_cmdinc___2024_08_30_17_30_57_118592"
...
## Baseline, ART
```{r}
# Version 7, updated delay constant
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-baseline_art___2024_08_20_15_01_50_381862"
...
```{r}
# Version 7 August 2024
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-baseline_noart___2024_08_20_15_04_13_512611"
...
p <- ggplot() +
    geom_line(data = croi.prev.data %>% filter(Year > 1985, scenario_name == "baseline.art"), 
              aes(x = Year, y = Prevalence, group = sim.id), linewidth = .1, color = 'gray', show.legend = FALSE) + 
    geom_line(data= croi.prev.data.mean %>% filter(Year > 1985, scenario_name == "baseline.art"),
            aes(x=Year, y=Prevalence, group=scenario_name, color = Gender), linewidth=2, show.legend = FALSE) +
    facet_wrap(~ Gender, ncol=2) +
    #xlab("Year")+
    #xlim(c(date.start, date.end)) +
    #ylab("Prevalence") +
...
ggsave("kenya_prevalence.pdf", p, width = 8, height =4, units= 'in')
```


## Number on ART over times
...
```{r}
rbind(
  aggregate.data(sim.results.all, "baseline.art",
                 1985, 2035, 15,100),
  aggregate.data(sim.results.all, "decouple.art",
                 1985, 2035, 15,100)
)

c(1230741- 1095500, 661067.8 - 586675.4, 12882177 - 11737513)
```
...
#write_csv(numbers.table, "numbers_table_20240820.csv")
write_csv(numbers.table, "numbers_table_20240906.csv")
```
...
#write_csv(differences.table, "differences_table_20240820.csv")
write_csv(differences.table, "differences_table_20240906.csv")
...
# Version 7
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_decouple-decouple_noart___2024_08_26_12_28_54_517287"
...
```{r}
sim.results.impact %>% filter(scenario_name == "baseline.noart") %>% 
  group_by(sim.i)
```


```{r}
measure.art.impact(sim.results.impact, "Died_from_HIV", 1985, 2000, 15, 100)
```

```{r}
measure.art.impact(sim.results.impact, "Newly.Infected", 1985, 2000, 15, 100)
```


```{r}
measure.art.impact(sim.results.impact, "Died_from_HIV", 2000, 2015, 15, 100)

measure.art.impact(sim.results.impact, "Newly.Infected", 2005, 2015, 15, 100)
```

```{r}
impact.table %>% filter(Years == "2000-2015", Ages == "15-100")
```
...
#write_csv(impact.table, "impact_of_art_table_20240820.csv")

write_csv(impact.table, "impact_of_art_table_20240827.csv")

impact.table.20240719 <- read_csv("impact_of_art_table_20240719.csv")
```
...
```{r}
numbers.table <- read_csv("numbers_table_20240906.csv")

differences.table <- read_csv("differences_table_20240709.csv")

impact.table <- read_csv("impact_of_art_table_20240820.csv")
```
...
ggsave("hiv_deaths_figure_pct_20240907.pdf", p, width = 16, height = 8, units = "in")
...
ggsave("hiv_infections_figure_pct_20240907.pdf", p, width = 16, height = 8, units = "in")
...
impact.table <- read.csv("impact_of_art_table_20240820.csv") #read.csv("impact_of_art_table_20240719.csv")
...
ggsave("hiv_impact_deaths_20240827.pdf",  plot = p.impact.deaths, width = 8, height = 4, units = "in")
```
...
ggsave("hiv_impact_infections_20240827.pdf", plot = p.impact.infections, width = 8, height = 4, units = "in")
...
ggsave("hiv_impact_deaths_pct_20240827.pdf",
       plot = p.impact.deaths.pct, 
...
ggsave("hiv_impact_infections_pct_20240827.pdf", plot = p.impact.infections.pct,
       width = 8, height = 4, units = "in")

```

## Impact of depression by age

```{r}
differences.table %>% colnames

# Show stacked bar chart broken down by age group
ggplot() + 
geom_col(
  data = differences.table %>% filter(Ages == "15-25", scenario_name == "baseline.art", Time < 5),
  mapping = aes(x = Time, y = 100 * Died_from_HIV.diff), 
       width = .5, color = 'red' , show.legend = FALSE, position = "dodge") + 
geom_col(
  data = differences.table %>% filter(Ages == "25-100", scenario_name == "baseline.art", Time < 5),
  mapping = aes(x = Time, y = 100 * Died_from_HIV.diff), 
       width = .5, color = 'blue', show.legend = FALSE, position = "dodge") 

```

```{r}
p1 = differences.table %>% 
  filter(scenario_name == "baseline.art", Time < 5, Ages %in% c("15-25", "25-100")) %>% 
  ggplot() + 
  geom_bar(mapping = aes(fill = Ages, x = Time, y = Newly.Infected.diff),
           position = 'fill', stat = "identity") + 
  scale_fill_manual("Ages", values=c("blue", "red"), labels = c("15-25", "25+")) + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),
                     ) + 
  scale_x_continuous(breaks = c(1,2,3,4), 
                     labels = c("Pre-ART\n1985-2005", "ART Scale-up\n2005-2015", 
                                "Universal ART\n2015-2025","Future\n2025-2035")) + 
  labs(x = "", y = "% New Infections Attributable to Depression") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(),
    axis.text = element_text(color = 'black'))

p2 = differences.table %>% 
  filter(scenario_name == "baseline.art", Time < 5, Ages %in% c("15-25", "25-100")) %>% 
  ggplot() + 
  geom_bar(mapping = aes(fill = Ages, x = Time, y = Newly.Infected.diff),
  ...
  scale_x_continuous(breaks = c(1,2,3,4), 
                     labels = c("Pre-ART\n1985-2005", "ART Scale-up\n2005-2015", 
                                "Universal ART\n2015-2025","Future\n2025-2035")) + 
  scale_y_continuous(breaks = seq(0,50000,10000), labels = c("0", "10,000", "20,000", "30,000", "40,000", "50,000")) +
  labs(x = "", y = "New Infections Attributable to Depression") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(),
...
p3 <- differences.table %>% 
  filter(scenario_name == "baseline.art", Time < 5, Ages %in% c("15-25", "25-100")) %>% 
  ggplot() + 
  geom_bar(mapping = aes(fill = Ages, x = Time, y = Died_from_HIV.diff),
           position = 'fill', stat = "identity") + 
  scale_fill_manual("Ages", values=c("blue", "red"), labels = c("15-25", "25+")) + 
  scale_y_continuous(labels = scales::percent_format(accuracy = 1),
                     ) + 
  scale_x_continuous(breaks = c(1,2,3,4), 
                     labels = c("Pre-ART\n1985-2005", "ART Scale-up\n2005-2015", 
                                "Universal ART\n2015-2025","Future\n2025-2035")) + 
  labs(x = "", y = "% HIV Deaths Attributable to Depression") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(),
    axis.text = element_text(color = 'black'))

p4 <- differences.table %>% 
  filter(scenario_name == "baseline.art", Time < 5, Ages %in% c("15-25", "25-100")) %>% 
  ggplot() + 
  geom_bar(mapping = aes(fill = Ages, x = Time, y = Died_from_HIV.diff),
           position = 'stack', stat = "identity")+ 
  ...
  scale_x_continuous(breaks = c(1,2,3,4), 
                     labels = c("Pre-ART\n1985-2005", "ART Scale-up\n2005-2015", 
                                "Universal ART\n2015-2025","Future\n2025-2035")) + 
  scale_y_continuous(breaks = seq(0,20000,5000), labels = c("0", "5000", "10,000", "15,000", "20,000")) +
  labs(x = "", y = "HIV Deaths Attributable to Depression") + 
  theme_bw() + 
  theme(panel.grid.major = element_blank(), 
    panel.grid.minor = element_blank(),
...
ggsave(filename = "fig.depression_impact_by_age_over_time.pdf",
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305_cmdinc_UL-sa_cmdinc_UL___2024_09_06_11_58_38_014147"  
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_hivinc_LL___2024_08_20_15_08_59_667169"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_hivinc_UL___2024_08_20_15_11_22_144834"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_artadh_LL___2024_08_20_15_13_43_494481"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_artadh_UL___2024_08_20_15_16_03_078104"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_artdrop_LL___2024_08_20_15_18_24_332929"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_delay_UL___2024_08_20_15_25_23_513326"
...
experiment.path = "/gpfs/scratch/citrod01/experiments/MATUMAINI/manuscript/Baseline-campaign_MATUMAINI_202305-sa_delay_LL___2024_08_20_15_23_04_552905"
...
}  # No idea why this doubles everything. It really really shouldn't.
...
sa.differences.table <- sa.differences.table %>% group_by(Period, Years, Ages, scenario_name) %>% slice(1)

sa.differences.table %>% write_csv("sensitivity_analysis_table_20240906.csv")
...
```{r}
sa.results.all %>% filter(Year >= 1985, Year <= 2035,
                          Age>15, Age <100) %>% 
  group_by(scenario_name, sim.ix) %>% 
  summarise(Newly.Infected = sum(Newly.Infected), Died_from_HIV = sum(Died_from_HIV)) %>% 
  group_by(scenario_name) %>% 
  summarize(Newly.Infected = mean(Newly.Infected), Died_from_HIV = mean(Died_from_HIV)) %>%
  mutate(Newly.Infected.diff = Newly.Infected - 66384.90,
         Died_from_HIV.diff = Died_from_HIV - 62145.12	)
```
```{r}
rbind(
  sa.results.all %>% 
    filter(Age >= 15, Age < 100, Year >=1985, Year < 2035) %>% 
    filter(IP_Key.CMDStatus == "CMD_pos") %>%
    group_by(scenario_name, sim.ix) %>% 
    summarize( Depression.eps = sum(Population/2* pop.scaling.factor),
                      .groups = 'keep') %>%
              ungroup() %>% 
    group_by(scenario_name) %>% 
    summarize(Depression.eps = mean(Depression.eps)), 
  sa.results.all %>% 
    filter(Age >= 15, Age < 100, Year >=1985, Year < 2035) %>% 
    filter(IP_Key.CMDStatus == "CMD_pos") %>%
    group_by(scenario_name, sim.ix) %>% 
  ...
  mutate(Depression.eps.diff = Depression.eps - 11737513)
```



```{r}
sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100")
```
```{r}
differences.table %>% filter(Years == "1985-2035", Ages == "15-100")
```


### Make Figures

#### Sensitivity Analysis - New Infections
```{r}

center.infs = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", scenario_name == "baseline.art") %>% .$Newly.Infected.pct

p.sa.infections <- ggplot() + 
  geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 0),
            mapping = aes(ymin = -ix, ymax =- ix - 1, 
                          xmin = Newly.Infected.pct, 
                          xmax = center.infs), fill = "#00468B") + 
    geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 1),
            mapping = aes(ymin =- ix, ymax =- ix - 1, 
                          xmin = center.infs, 
                          xmax = Newly.Infected.pct), fill = "#ED2200") + 
  geom_vline(xintercept = center.infs, linetype = "dashed", color = "black") +
  #scale_x_continuous(breaks = c(15, 17.5, 20, 22.5, 25)/100, 
  #                   limits = c(.15, .25), labels = scales::percent_format(accuracy = 1)) + 
...
```{r}
center.deaths = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", scenario_name == "baseline.art") %>% .$Died_from_HIV.pct

p.sa.deaths <- ggplot() + 
  geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 0),
            mapping = aes(ymin = -ix, ymax =- ix - 1, 
                          xmin = Died_from_HIV.pct, 
                          xmax = center.deaths), fill = "#00468B") + 
    geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 1),
            mapping = aes(ymin =- ix, ymax =- ix - 1, 
                          xmin = center.deaths, 
                          xmax = Died_from_HIV.pct), fill = "#ED2200") + 
  geom_vline(xintercept = center.deaths, linetype = "dashed", color = "black") + 
...
```{r}
center.dep = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", scenario_name == "baseline.art") %>% .$Depression.eps.pct

p.sa.dep <- ggplot() + 
  geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 0),
            mapping = aes(ymin = -ix, ymax =- ix - 1, 
                          xmin = Depression.eps.pct, 
                          xmax = center.dep), fill = "#00468B") + 
    geom_rect(data = sa.differences.table %>% filter(Years == "1985-2035", Ages == "15-100", limitsign == 1),
            mapping = aes(ymin =- ix, ymax =- ix - 1, 
                          xmin = center.dep, 
                          xmax = Depression.eps.pct), fill = "#ED2200") + 
  geom_vline(xintercept = center.dep, linetype = "dashed", color = "black") + 
  scale_x_continuous(labels = scales::percent_format(accuracy = 1)) + 
  theme_minimal() + theme_bw() +
  theme(panel.grid = element_blank(), # change x or y grid, use panel.grid.major.x / panel.grid.minor.x
        axis.title.y = element_blank(), axis.ticks.y = element_blank(), axis.text.y = element_blank(),
...
```{r}
p.sa <- p.sa.infections + p.sa.deaths + p.sa.dep

ggsave("sensitivity_analysis_20240907.pdf", p.sa, width = 9, height = 3, units = 'in')

p.sa
```
# Deprecated - Analysis of Metrics
