...
impact.table <- read.csv("impact_of_art_table_20240827.csv")
...
```{r}
sa.differences.table <- read_csv("sensitivity_analysis_table_20240906.csv")
```
...
#  scale_x_continuous(labels = scales::percent_format(accuracy = 3)) + 
  scale_x_continuous(breaks = c(8,10,12,14,16)/100,
                    limits = c(.08, .17), labels = scales::percent_format(accuracy = 1)) +
