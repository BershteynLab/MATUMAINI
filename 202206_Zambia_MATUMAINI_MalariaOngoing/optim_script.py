...
BASE_POPULATION_SCALE_FACTOR = 0.13 # For quick test simulations, this is set to a very low value. 0.005 for testing. Use 0.2 for full calibration
N_ITERATIONS = 400
N_SAMPLES_PER_ITERATION = 6  # the number of distinct parameter sets to run per iteration
...
optimtool = OptimTool(
    ...
    center_repeats=5,  # 10 is real size, 2 is testing
